...
{data.map((item) => (
    ...
    <div>
      ...
      <iframe className="video_thumbnail_macbook_air_m1"
            src="https://www.youtube.com/embed/26m-dOrr9qU" title="UNBOX MACBOOK PRO M3 MỚI NHẤT: 50 CỦ CHO MÀU MỚII"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
