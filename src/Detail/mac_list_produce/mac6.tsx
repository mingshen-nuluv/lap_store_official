...
{data.map((item) => (
    ...
    <div>
      ...
      <iframe className="video_thumbnail_macbook_air_m1"
          src="https://www.youtube.com/embed/bMsiIN95GY8" title="2023 MacBook Air 15-inch M2 Unboxing, Setup and First Look"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
