    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
              src="https://www.youtube.com/embed/HeMIZC2rkMo" title="M2 MacBook Air Review: More Than a Refresh!" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
          ...
          <div className='under_header_option'>
              <div className="under_header_option_box">
                ...
                <div  className="under_header_option_right">
                  <p className="uhor_price">29.390.000₫</p>
                  <p className='uhor_text'>32.990.000₫</p>
