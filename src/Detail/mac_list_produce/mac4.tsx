...
{data.map((item) => (
    ...
    <div>
      ...
      <iframe className="video_thumbnail_macbook_air_m1"
             src="https://www.youtube.com/embed/0pg_Y41waaE" title="The new MacBook Pro | Apple"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
