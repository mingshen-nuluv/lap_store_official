...
{data.map((item) => (
    ...
    <div>
      ...
      <iframe className="video_thumbnail_macbook_air_m1"
           src="https://www.youtube.com/embed/PTunTseQWZw" title="16&quot; M2 MacBook Pro - One Month Later!"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
