...
{data.map((item) => (
    ...
    <div>
      ...
      src="https://www.youtube.com/embed/kxQMQlRSg38" title="Mac mini (M2, 2023) One Month Later Review!"   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  ></iframe>
