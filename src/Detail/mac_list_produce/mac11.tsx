...
{data.map((item) => (
    ...
    <div>
      ...
      <iframe className="video_thumbnail_macbook_air_m1"
            src="https://www.youtube.com/embed/Lhfa5S8E05M" title="Apple Mac Studio Review (M1 Ultra) - HOLY SH*T!"   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  ></iframe>
