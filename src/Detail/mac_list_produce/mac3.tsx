    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
            src="https://www.youtube.com/embed/_iceQRRrx-o" title="M3 MacBook Air 2024 Release Date and Price - SPRING DATE LAUNCH?"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  ></iframe>
          ...
          <div className='under_header_option'>
              <div className="under_header_option_box">
                ...
                <div   className="under_header_option_left" >
                  <p className='uhol_price'>24.690.000 đ</p>
                  <p className='uhol_text'>Khi thu cũ lên đời</p>
                </div>
                <div  className="under_header_option_right">
                  <p className="uhor_price">27.390.000</p>
                  <p className='uhor_text'>27.390.000₫</p>
