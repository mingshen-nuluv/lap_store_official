...
<>
    <div className='header_detail'>
          ...
          <p className='header_title'>Laptop ASUS Zenbook 14 OLED UM3402YA-KM405W</p>
            </div>
    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
                src="https://www.youtube.com/embed/1ohSbFYiY9Q" title="The new Zenbook 14 OLED (UM3402) - Feature Overview | ASUS" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
