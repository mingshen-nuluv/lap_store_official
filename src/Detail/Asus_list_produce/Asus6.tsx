...
<>
    <div className='header_detail'>
          ...
          <p className='header_title'>Laptop ASUS VivoBook Go 14 E1404FA-NK177W</p>
            </div>
    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
                src="https://www.youtube.com/embed/_pHSEXWxe_w" title="Laptop Komplit &amp; Murah Untuk Pelajar: Review ASUS Vivobook Go 14 E1404"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
