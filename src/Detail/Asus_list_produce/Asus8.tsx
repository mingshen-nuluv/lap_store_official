...
<>
    <div className='header_detail'>
          ...
          <p className='header_title'>Laptop ASUS Gaming ROG Zephyrus G14 GA402NJ-L4056W</p>
            </div>
    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
               src="https://www.youtube.com/embed/GejXnyse-b4" title="ROG Zephyrus G14 | ROG"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
