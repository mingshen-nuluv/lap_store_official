...
<>
    <div className='header_detail'>
          ...
          <p className='header_title'>Laptop ASUS Zenbook 14 Oled UX3405MA-PP151W</p>
            </div>
    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
                src="https://www.youtube.com/embed/nI7aDHo-AGk" title="Asus Zenbook 14 OLED UX3405MA Review - Intel 14th Gen Laptop"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
