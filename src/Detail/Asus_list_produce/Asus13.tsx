...
<>
    <div className='header_detail'>
          ...
          <p className='header_title'>Laptop ASUS VivoBook 15 OLED A1505VA-L1201W</p>
            </div>
    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
              src="https://www.youtube.com/embed/mxWGSBKWxI4" title="ASUS Vivobook Pro 15 OLED (N6506) #Intel | 2024" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
