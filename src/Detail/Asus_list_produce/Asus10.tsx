...
<>
    <div className='header_detail'>
          ...
          <p className='header_title'>Laptop ASUS VivoBook 14 OLED A1405VA-KM095W</p>
            </div>
    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
               src="https://www.youtube.com/embed/ngkvRnZF1pQ" title="ASUS Vivobook Pro 14 OLED Laptop Review"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
