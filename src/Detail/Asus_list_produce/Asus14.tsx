...
<>
    <div className='header_detail'>
          ...
          <p className='header_title'>Laptop ASUS TUF Gaming A15 FA506NF-HN005W</p>
            </div>
    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
              src="https://www.youtube.com/embed/TNnLD6ssU7A" title="2021 ASUS TUF Gaming A15 - Outlast the Competition | ASUS"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
