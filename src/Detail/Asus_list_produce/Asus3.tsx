...
<>
    <div className='header_detail'>
          ...
          <p className='header_title'>Laptop ASUS VivoBook 15 OLED A1505VA-L1114W</p>
            </div>
    ...
    <div className='under_header_mac_air_m1'>
      <div className='video_box'>
        <iframe className="video_thumbnail_macbook_air_m1"
                src="https://www.youtube.com/embed/xhHm3LYNdyQ" title="Asus vivobook 15 oled unboxing | Laptop unboxing"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
